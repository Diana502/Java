...
public class Consumer2 {
	...
	public static void main(String[] args) throws Exception {
		...
		channel.queueDeclare("testPublishQueue2", false, false, false, null);
		channel.queueBind("testPublishQueue2", EXCHANGE_NAME, "");
		channel.basicQos(2);
		...
		channel.basicConsume("testPublishQueue2",false,consumer);
